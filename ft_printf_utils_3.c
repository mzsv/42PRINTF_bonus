...
/*   Updated: 2023/07/03 22:24:45 by amenses-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

void	ft_setflags(t_content *a, const char *fmt) // D
{
	char		*f;
...
void	ft_setfw(t_content *a, const char *fmt) // D
{
	size_t	i;
	size_t	j;
	char	*tmp;
...
void	ft_setprc(t_content *a, const char *fmt) // D
{
	size_t	i;
	size_t	j;
	char	*tmp;
